...
body {
  ...
  background: url('https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80') top center no-repeat;
...
<header class="header">
  <h1 class="logo">Waste Manager</h1>
  <ul class="nav">
   @if (Route::has('login'))
   @auth
