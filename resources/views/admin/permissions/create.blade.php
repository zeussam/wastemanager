...
<body class="antialiased bg-gray-100 dark-mode:bg-gray-900">
    ...
    <a href="{{route('admin.permissions.index')}}" style="background-color: #232628; color: white;" onmouseover="this.style.backgroundColor='#ef6339';" onmouseout="this.style.backgroundColor='#232628';" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-md">Permission Index</a>
</div>
  ...
  @csrf
    ...
    <div class="sm:col-span-6 pt-5">
      <button type="submit" style="background-color: #ef6339; color: white;" onmouseover="this.style.backgroundColor='#232628';" onmouseout="this.style.backgroundColor='#ef6339';" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-md">Create</button>
    </div>
  </form>
</div>   
    </div>
