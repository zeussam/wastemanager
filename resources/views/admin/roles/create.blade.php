...
<body class="antialiased bg-gray-100 dark-mode:bg-gray-900">
    ...
    <a href="{{route('admin.roles.create')}}" style="background-color: #232628; color: white;" onmouseover="this.style.backgroundColor='#ef6339';" onmouseout="this.style.backgroundColor='#232628';" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-md">Role Index</a>
</div>
